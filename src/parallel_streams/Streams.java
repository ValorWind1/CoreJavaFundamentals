...
public class Streams {
    public static void main(String[] args) {
        ...
        System.out.println("Stream Time = " + (before - after));

        // parallel stream

         before = System.currentTimeMillis();
         count = employees.stream().filter(e -> e.getSalary() > 100000).count();
         after = System.currentTimeMillis();

        System.out.println("Parellel Stream count = " + count );
        System.out.println("Parallel Stream Time = " + (before - after));
